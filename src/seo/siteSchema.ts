...
export const siteSchemaGraph = {
  ...
  '@graph': [
    ...
    service('ecommerce', 'Online Shops and eCommerce', 'Web development', '/services'),
    service('booking-systems', 'Booking and Appointment Systems', 'Web application development', '/services'),
    service('bespoke-apps', 'Bespoke Web Applications', 'Software development', '/services'),
  ],
}
